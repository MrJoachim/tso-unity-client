...
function createWindow() {
  ...
  ipcMain.on("loadGame", (event, arg) => {
    mainWindow.loadURL(
      ...
      encodeURI("  <style>      body{        background-color: #FEF3EA;        display:flex;        justify-content: center;        align-items: center;        flex:1;        height:100vh;        padding:0;        margin:0;      font-family: arial;      }      h1{        color:#372816;      }    </style>  <h1>The game is downloading.. Please do not close.</h1>")
    );
